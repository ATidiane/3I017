...
public class SqlTest {
	...
	public static void main(String args[]) {
		...
		try {
			...
			//JSONObject objlog = LoginS.login("ahmed", "ahhh");
			//System.out.println(objlog.toString());
			//LogoutS.logout(UserTools.getKey("ahmed"));
			System.out.println(UserTools.getKey("ahmed"));
			...
			//System.out.println(AddCommentS.addComment(UserTools.getKey("Viniya"), "Nice picture!"));
